...
public class EventFullActivity extends  AppCompatActivity  { 
	...
	private TextView textview_gmail;
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		textview_gmail = (TextView) findViewById(R.id.textview_gmail);
	}
	
	private void initializeLogic() {
		Glide.with(getApplicationContext()).load(Uri.parse(getIntent().getStringExtra("image1"))).into(imageview1);
		Glide.with(getApplicationContext()).load(Uri.parse(getIntent().getStringExtra("cimage1"))).into(circleimageview1);
		textview_des.setText(getIntent().getStringExtra("t_d"));
		textview_name.setText(getIntent().getStringExtra("t_n"));
		textview_gmail.setText(getIntent().getStringExtra("t_g"));
	}
